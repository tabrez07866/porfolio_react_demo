...
const Contact = () => {
    return <section id='contact' className='pb-16'>
        <div className="container">
            <h1 className='text-headingColor font-[700 ] text-[2.5rem] mb-7 '>Get in Touch</h1>
            <div className="md:flex justify-between items-center ">
                <div className="w-full md:w-1/2 h-[300px] sm:h-[450px]">
                    <iframe title='google-maps' src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d195736.23789272335!2d80.94942006467937!3d26.844808767489255!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x399bfd991f32b16b%3A0x93ccba8909978be7!2sLucknow%2C%20Uttar%20Pradesh!5e0!3m2!1sen!2sin!4v1693549357666!5m2!1sen!2sin"
